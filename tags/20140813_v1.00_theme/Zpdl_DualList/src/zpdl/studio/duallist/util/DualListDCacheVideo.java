...
public class DualListDCacheVideo extends DualListDCacheData {
    public static final int Version = 1;

    private static final int WIDTH      = 0x0001;
    private static final int HEIGHT     = 0x0002;
    private static final int DURATION   = 0x0004;
    private static final int THUMBNAIL  = 0x0008;
    ...
    public DualListDCacheVideo() {
        super(DualListItem.VIDEO);
    ...
    public DualListDCacheVideo(Bitmap thumbnail, Integer width, Integer height, Long duration) {
        this();
    ...
    public void write(BufferedOutputStream out) throws IOException {
        ...
        if((mFlag & DURATION) == DURATION) {
            out.write(longTobyte(mDuration.longValue()));
        }
        if((mFlag & THUMBNAIL) == THUMBNAIL) {

...
public class ApiFile {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    error = null;
                    ApiFileSizeAndCount sc = _getFileSizeAndCount(in);
    ...
    private static ApiFileSizeAndCount _getFileSizeAndCount(String[] fileList) {
        ApiFileSizeAndCount sizeAndcount = new ApiFileSizeAndCount();
        for(String path : fileList) {
    ...
    private static ApiFileSizeAndCount _getFileSizeAndCount(String path) {
        ApiFileSizeAndCount sizeAndcount = new ApiFileSizeAndCount();
        LinkedList<String> ll = new LinkedList<String>();
        ll.offer(path);
